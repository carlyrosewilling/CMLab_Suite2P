...
addpath(fullfile('X:','Suite2P_Data+Analysis', 'MATLAB', 'Customized-Suite2P')); 
addpath(fullfile('X:','Suite2P_Data+Analysis', 'MATLAB', 'Customized-Suite2P', 'Suite2P-master'));
...
ops0.toolbox_path = fullfile('X:','Suite2P_Data+Analysis', 'MATLAB', 'Customized-Suite2P', 'Suite2P-master');
if exist(ops0.toolbox_path, 'dir')
	addpath(genpath(ops0.toolbox_path)); %path to toolbox
else
	error('toolbox_path does not exist, please change toolbox_path');
end
addpath(fullfile('X:','Suite2P_Data+Analysis', 'MATLAB', 'OASIS_matlab-master'));
addpath(genpath(fullfile('X:','Suite2P_Data+Analysis', 'MATLAB', 'OASIS_matlab-master', 'oasis'))); %Path to OASIS
...
ops0.RootStorage            = fullfile('X:','Suite2P_Data+Analysis', 'DATA'); %root location where the raw tiff files are stored
...
ops0.RegFileRoot            = fullfile('X:','Suite2P_Data+Analysis', 'DATA'); %location where to keep registered movies in binary format
...
ops0.ResultsSavePath        = fullfile('X:','Suite2P_Data+Analysis', 'DATA','Registered_Planes'); %where to save data results (i.e. F*.mat file)
ops0.RegFileTiffLocation    = fullfile('X:','Suite2P_Data+Analysis', 'DATA', 'Registered_Tiffs'); %where to save registered tiffs 
